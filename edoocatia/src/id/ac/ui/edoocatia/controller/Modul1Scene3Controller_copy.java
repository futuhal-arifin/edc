...
import id.ac.ui.edoocatia.screen.Modul1Scene3Screen_copy;
...
public class Modul1Scene3Controller_copy {

	private Edoocatia app;
	private Modul1Scene3Screen_copy screen;
	private Rectangle[] imageBounds;
	private Rectangle viewport;
	private OrthographicCamera cam;
	private int mistakes = 0;

	public Modul1Scene3Controller_copy(Modul1Scene3Screen_copy screen) {
		this.screen = screen;
		app = screen.getApp();
		cam = screen.getCam();
