...
import id.ac.ui.edoocatia.controller.Modul1Scene3Controller_copy;
import id.ac.ui.edoocatia.controller.Modul1Scene6Controller;

public class Modul1Scene3Screen_copy extends ProfessorInstructionScreen {

	private Modul1Scene3Controller_copy controller;
	...
	public Modul1Scene3Screen_copy(Edoocatia app) {
		...
		controller = new Modul1Scene3Controller_copy(this);
	}
