...
import id.ac.ui.edoocatia.controller.Modul1Scene5Controller_copy;

public class Modul1Scene5Screen_copy extends ProfessorInstructionScreen {
	private Modul1Scene5Controller_copy controller;
	...
	public Modul1Scene5Screen_copy(Edoocatia app) {
		super(app);
		this.setState(this.PROF_INSTRUCTION);
		controller = new Modul1Scene5Controller_copy(this);
	}
