...
public class ProfessorInstructionScreen extends DialogScreen {
	...
	public ProfessorInstructionScreen(Edoocatia app) {
		...
		this.setDialogBackgroundPosition(
				100 + (this.getWidth() - this.dialogBackground.getWidth()) / 2,
				0);
	...
	public void setInstructionObject(String path) {
		...
		this.instructionObjectXPosition = (VIRTUAL_WIDTH - this.instructionObject
				.getWidth()) / 2;
		this.instructionObjectYPosition = 100 + (VIRTUAL_HEIGHT - this.instructionObject
				.getHeight()) / 2;
		;
	}
